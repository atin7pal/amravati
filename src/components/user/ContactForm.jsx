    ...
    <div className="w-[90%] max-sm:w-full max-sm:px-4 max-sm:p-4 mx-auto py-6 px-10 bg-white">
      ...
      >
        ...
        <div>
          ...
          />
          {errors.email && (
            <p className="text-red-500 text-xs accentfont">{errors.email.message}</p>
          )}
        </div>
        </div>
         <div className="flex gap-4 mt-2">
        ...
        <div>
          ...
          />
          {errors.phone && (
            <p className="text-red-500 text-xs accentfont">{errors.phone.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          />
          {errors.city && (
            <p className="text-red-500 text-xs accentfont">{errors.city.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          />
          {errors.state && (
            <p className="text-red-500 text-xs accentfont">{errors.state.message}</p>
          )}
        </div>
        </div>
        ...
        <div>
          ...
          {errors.category && (
            <p className="text-red-500 text-xs accentfont">{errors.category.message}</p>
          )}
        </div>
        ...
        <div className="sm:col-span-2">
          ...
          />
          {errors.query && (
            <p className="text-red-500 text-xs accentfont">{errors.query.message}</p>
          )}
        </div>
