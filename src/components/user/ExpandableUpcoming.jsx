...
export default function ExpandableUpcoming({ projects, project }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2 className="text-3xl capitalize max-sm:text-2xl">
            {project.name}
          </h2>
          ...
          <p className="mt-2 accentfont w-[90%] max-sm:text-sm">
            {project.description}
          </p>
