  ...
  return (
    <>
      ...
      <section className="section bg-gradient-to-b from-[#ece4d9] via-white to-[#ece4d9] ">
        ...
        <img src={Project.coverImage} className="h-[50vh] object-cover w-full" alt="" />
        <p className="text-center accentfont text-lg">{Project.description}</p>
        </div>
        </div>

        <div className="row">
            <div className="flex flex-col justify-center items-start w-full">
                <h2 className="text-4xl max-sm:text-3xl w-[80%] max-sm:w-full mb-6 bgcolorfont">Projects</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 w-full">
          {Project.projects?.map((sub) => (
            ...
            >
              ...
              <p className="accentfont">{sub.tagline}</p>
              <button className="btn w-fit">Project Overview</button>
            </Link>
          ))}
        </div>
        </div>
